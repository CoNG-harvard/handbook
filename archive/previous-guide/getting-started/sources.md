...
The [Lab resources guide](lab-resources.md) maps the supplied Robotics Lab Dropbox folder to the current manual. On 26 September 2026, the RealSense camera note and research-computing note were read in full, and relevant resource listings were inspected. Their historical status and review limits are recorded there. The camera note contributes a basic Viewer check; the archive does not change the source revisions or hardware-validation status recorded above.
