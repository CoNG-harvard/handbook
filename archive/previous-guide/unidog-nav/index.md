...
For earlier experiment material, see the [quadruped video archive](../getting-started/lab-resources.md#find-the-relevant-material). Confirm the robot and software version with the experiment owner before using it as a reference.
