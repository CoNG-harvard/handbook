...
**Setting up a new computer?** Start with the [setup handoff checklist](getting-started/index.md#2-get-a-setup-handoff-from-the-lab), then follow the computer-preparation steps in your project guide.
...
<p class="project-kind">Two arms · Leader control</p>

## [ABC Box](abc-box/index.md)

Guide two follower arms with hand-operated leaders, then save and review demonstrations using I2RT's collection tools.

[View project guide →](abc-box/index.md){ .project-link }
...
VLA Pipeline and Self Improvement Learning share **one RTX PRO 6000 workstation**. ABC Box has its own recording computer; later model work can use the shared workstation after validation. Each project has its own hardware list and software environment.
...
- [Lab resources](getting-started/lab-resources.md) — Dropbox setup notes, camera checks, and experiment archives.
